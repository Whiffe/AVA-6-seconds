...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=('../mmaction2/configs/detection/ava/'
                 'my_slowfast_kinetics_pretrained_r50_4x16x1_20e_ava_rgb.py'),
        help='spatio temporal detection config file path')
    parser.add_argument(
        '--checkpoint-slowfast',
        default=('/home/mmaction2/work_dirs/ava/slowfast_kinetics_pretrained_r50_4x16x1_20e_ava_rgb/best_mAP@0.5IOU_epoch_47.pth'),
    ...
    parser.add_argument(
        '--label-map',
        default='../mmaction2/tools/data/ava/label_map2.txt',
        help='label map file')
    parser.add_argument(
